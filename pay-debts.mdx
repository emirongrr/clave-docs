...
To pay your debts, you should follow these steps:
...
5. **Select Crypto**:If you chose to pay with crypto, select the type of crypto you want to use for the payment from the list provided.
