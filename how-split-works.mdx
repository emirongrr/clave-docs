...
Tabii ki, "split" özelliğine yönelik tutorial hazırlayalım.

## How to Create a Split Group and Add Friends
...
1. **Open the Clave App**:
   Launch the Clave app on your device and navigate to the "Hub" section.

2. **Select the Split Option**:
   In the Hub, find and select the "Split" icon.

 

3. **Create a New Group**:
   Click on the "Create New Group" button at the bottom of the screen.


4. **Name Your Group**:
   Enter a name for your split group, such as "Friends Dinner" or "Trip Expenses."

5. **Add Participants**:
   Click on "Invite Your Friends" to add members to your group. You can invite friends by entering their email addresses or selecting them from your contacts.
