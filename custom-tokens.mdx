...
If you want to add custom tokens to track your assets, you have two option. First one is, you can find with researching the token's name and second one is copying token's contract address and pasting it to the Clave.  Follow these steps to add custom tokens to your Clave wallet:
...
7. **Click on "Add Custom Tokens"** to complete the process.
