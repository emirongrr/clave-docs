...
1. **Go to Earn Hub and Select Your Position**:
   - Open the Earn Hub in the Clave app and select the position you want to withdraw from.

2. **Click Withdraw**:
   - Click the withdraw button.

3. **Type How Much You Want to Withdraw**:
   - Enter the amount you wish to withdraw.

4. **Click Collect and Withdraw**:
   - Click the collect and withdraw button.
