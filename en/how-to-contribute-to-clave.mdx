...
If you want to modify (fixing typos, enhancing the wording etc.) an existing translation, you can simply fork the project and start modifyingg the texts in the MDX files. Please follow PR Rules to Open a PR. 
