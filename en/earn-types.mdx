---
title: 'Earn Types'
description: "A Short Explainer About Where Do Yields Come From in Clave's Earn?."
---
...
Collectible earnings are funds you can withdraw and use at your discretion. These earnings provide immediate liquidity and flexibility, giving you the option to reinvest, spend, or save as you see fit. 
...
ZeroLend pools utilize this method to offer the best yield rates to our users, ensuring you have access to your funds whenever you need them.
 ...
 <Accordion title="Why do some protocols take a fee when depositing funds to Earn?">
        Adding LP to AMM pools comes with an extra risk: Impermanent Loss. To minimize this risk, we only use pools that have the same asset category (e.g. WstETH/ETH). So, the price change and Impermanent Loss risk is also minimal.
