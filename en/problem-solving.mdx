...
description: 'Having trouble with your Clave account? Here is a guide that includes common problems you might face and solutions'
---
...
First, check if your phone supports Passkey. To do so:

1. Go to **[webauthn.io](https://webauthn.io)**
2. **Enter any text into the input box** on the input box and click "Register"
3. **You should see that a passkey is generated.** See images below (left: Android, right: iPhone):
