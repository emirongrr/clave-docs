...
Wallet Connect allows us to connect Clave to **any dapp** that supports Wallet Connect connections. Follow these steps to connect your Clave wallet using Wallet Connect:
