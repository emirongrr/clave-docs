...
You can easily trade any crypto for another with just a few clicks while you have full custody of your funds. You can buy ETH, BTC, and many others with USDC, USDT, DAI, or any token on ZKsync Era. While trading, you will not see any network fee, so you can *free*ly discover the edges of DeFi.

For now, we are using [Odos Protocol](https://app.odos.xyz/?ref=blog2.getclave.io), one of the best aggregators in the ecosystem, to provide you with the best quote and route for the best possible price. We will add more options in the future.
...
Now you can swap any crypto using Clave’s built-in Swap function.
